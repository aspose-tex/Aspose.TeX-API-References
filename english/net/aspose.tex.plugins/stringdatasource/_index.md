...
description: Aspose.TeX.Plugins.StringDataSource class. The string data source for plugins load and save operations
type: docs
weight: 470
...
The string data source for plugin's load and save operations.
