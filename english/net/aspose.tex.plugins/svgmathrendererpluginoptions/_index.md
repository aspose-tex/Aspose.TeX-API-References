---
title: Class SvgMathRendererPluginOptions
...
```csharp
public class SvgMathRendererPluginOptions : MathRendererPluginOptions
```
...
| override [OperationName](../../aspose.tex.plugins/svgmathrendererpluginoptions/operationname/) { get; } | Returns operation name. |
