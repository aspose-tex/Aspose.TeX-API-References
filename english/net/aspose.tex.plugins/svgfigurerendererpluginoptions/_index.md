---
title: Class SvgFigureRendererPluginOptions
...
```csharp
public class SvgFigureRendererPluginOptions : FigureRendererPluginOptions
```
...
| override [OperationName](../../aspose.tex.plugins/svgfigurerendererpluginoptions/operationname/) { get; } | Returns operation name. |
