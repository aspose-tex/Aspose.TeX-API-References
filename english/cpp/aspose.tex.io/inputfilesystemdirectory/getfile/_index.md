...
```cpp
System::SharedPtr<Aspose::TeX::IO::NamedStream> Aspose::TeX::IO::InputFileSystemDirectory::GetFile(System::String fileName, bool searchSubdirectories=false) override
```
