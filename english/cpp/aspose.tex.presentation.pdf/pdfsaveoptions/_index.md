...
| [set_EncryptionDetails](./set_encryptiondetails/)(System::SharedPtr\<Aspose::TeX::Presentation::Pdf::PdfEncryptionDetails\>) | Sets a encryption details. If not set, then no encryption will be performed. |
| [set_ImageCompression](./set_imagecompression/)(Aspose::TeX::Presentation::Pdf::PdfImageCompression) | Specifies compression type to be used for all images in the document. Default is [PdfImageCompression::Auto](../pdfimagecompression/). |
...
| [set_TextCompression](./set_textcompression/)(Aspose::TeX::Presentation::Pdf::PdfTextCompression) | Specifies at which level in the document outline to display [ApsBookmark](../) objects. 0 - not displayed. 1 at first level and so on. Default is 0. |
## See Also
