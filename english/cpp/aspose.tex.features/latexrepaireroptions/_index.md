...
| [set_GuessPackageCallback](./set_guesspackagecallback/)(System::SharedPtr\<Aspose::TeX::Features::IGuessPackageCallback\>) | Gets/sets the callback to externally guess a required package by command name. |
