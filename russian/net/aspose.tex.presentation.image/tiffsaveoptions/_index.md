...
description: Класс представляющий варианты сохранения изображения в формате TIFF.
type: docs
weight: 340
url: /ru/net/aspose.tex.presentation.image/tiffsaveoptions/
---
## TiffSaveOptions class

Класс, представляющий варианты сохранения изображения в формате TIFF.
...
| Имя | Описание |
| --- | --- |
| [TiffSaveOptions](tiffsaveoptions)() | Конструктор по умолчанию. |
