...
description: Aspose.TeX.Presentation.Pdf 命名空间提供了用于将 TeX 文件排版为 PDF 的类
type: docs
weight: 60
url: /zh/net/aspose.tex.presentation.pdf/
---
**Aspose.TeX.Presentation.Pdf** 命名空间提供了用于将 TeX 文件排版为 PDF 的类。

## 课程

| 班级 | 描述 |
| --- | --- |
| [PdfDevice](./pdfdevice) | 实现将文本和图形内容输出到 PDF 文档的接口。 |
